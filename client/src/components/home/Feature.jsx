...
const Feature = () => {
    ...
    return (
        ...
        <div id="features" className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Build your Resume' description=' our streamlined process helps you create a professionals resume in minutes with intelligents Ai-powered tools and features.' />
            <div className="flex flex-col md:flex-row items-center justify-center xl:mt-10">
                <img className="max-w-2xl w-full xl:-ml-32" src={assets.dummy_profile} alt="" />
