...
const Testimonial = () => {
  ...
  return (
    ...
    <div id="testimonials" className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title="Don't just take our word" description="Hear what our user say about us . We're always looking for way to improve .if you have a positive experience with us ,leave a review" />                        
    </div>
