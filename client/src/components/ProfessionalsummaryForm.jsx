...
const ProfessionalsummaryForm = ({data, onChange, setResumeData}) => {
  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='mt-6'>
            <textarea value={data || ""} onChange={(e)=>onChange(e.target.value)} rows={7} name='' id='' className='w-full p-3 px-4 mt-2 border text-sm border-gray-300 rounded-lg focus:ring-blue-500
             focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write a compelling professional summary that highlights
              your key strength and career objectives...'>
            </textarea>
            <p className='text-xs text-gray-500 max-w-4/5 mx-auto text-center '>Tip: keep it concise (3-4 sentance) and focus on your most relevant achivements and skills.</p>
        </div>    
    </div>
  )
}
