...
const Personalinfoform = ({data, onChange, removeBackground, setRemoveBackground}) => {
    ...
    const fields=[
        ...
        {key:"linkedin", label:"Linkedin Website", icon:Linkedin, type:"url"},
        ...
        {typeof data.image === 'object' && (
            <div className='flex flex-col gap-1 pl-4 text-sm'>
                ...
                <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                    <input type="checkbox" className="sr-only peer" id="" onChange={()=>setRemoveBackground(prev => !prev)} checked={removeBackground} />
      ...
      {fields.map((field)=>{
        ...
        return(
            <div key={field.key} className='space-y-1 mt-5'>
                <label className='flext items-center gap-2 text-sm font-medium text-gray-600'>
