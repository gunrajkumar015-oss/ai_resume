...
import {PhoneCall, Plus, Sparkles, X} from 'lucide-react'
  ...
  return (
    <div className='space-y-4'>
      <div className=''>
        ...
        <p className='text-sm text-gray-500'>Add your techanical and soft skills</p>
      </div> 
      ...
      {data.length > 0 ? (
        ...
        <div className='text-center py-6 text-gray-500'>
          ...
          <p className='text-sm'>Add your techanical and soft skills above.</p>
        </div>
      )} 
      <div className='p-3 bg-blue-50 rounded-lg'>
        <p className='text-sm text-blue-800'>
          <strong>Tip:</strong>
          Add 8-12 relevant skills. Include both techanical skills (programming language,tools) and soft skills (leadership, communication).</p>
      </div>
    </div>
  )
}
