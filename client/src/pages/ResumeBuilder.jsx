...
const ResumeBuilder = () => {
  ...
  const handleShare = ()=>{
    ...
    const resumeUrl = frontedUrl + '/views/' + resumeId;
  ...
  return (
    <div>
      ...
      <div  className='max-w-7xl mx-auto px-4 py-6'>
        <Link to={'/app/dashboard'} className=' inline-flex gap-2 items-center text-slate-500 hover:text-slate-700 transition-all'>
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <hr className='absolute top-0 left-0 h-1 bg-gradient-to-rb from-green-500
               to-green-600 border-none transition-all duration-1000'
              ...
              <button onClick={()=> {toast.promise(saveResume, {loading: 'saving...'})}} className='rounded-md bg-gradient-to-br from-gray-100 to-green-200 ring-green-300 text-green-600 ring hover:ring-green-400 transition-all px-6 py-2 mt-6 text-sm'>
                Save Changes
              </button>
            </div>
          </div>
            ...
            <div className='relative w-full'>
              ...
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                <button onClick={ChangeResumeVisibility} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200
                   text-purple-600 rounded-lg ring-blue-300 hover:ring transition-colors'>
                  {resumeData.public ? <EyeIcon className='size-4'/> : <EyeOffIcon className='size-4'/>}
                  {resumeData.public ? 'Public' : 'Private'}
                </button>
                <button onClick={dowloadResume} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-green-100 to-green-200
                   text-green-600 rounded-lg ring-blue-300 hover:ring transition-colors'>
